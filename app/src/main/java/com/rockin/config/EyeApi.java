...
public class EyeApi {
    ...
    private static final String EYE_IP = "http://47.100.7.114:8080";

    /**
     * 获取首页视频的接口（最少能拿到 8 条数据）
     */
    public static final String VIDEO_HOMEPAGE = EYE_IP + "/Eyepetizer/Video/HomePage";

    /**
     * 获取视频播放页面 30 条视频推荐
     */
    public static final String VIDEO_RECOMMEND = EYE_IP + "/Eyepetizer/Video/Recommend";

    /**
     * 热门： http://baobab.kaiyanapp.com/api/v4/discovery/hot?start=0&num=20
     * 分类： http://baobab.kaiyanapp.com/api/v4/discovery/category
     * 作者： http://baobab.kaiyanapp.com/api/v4/pgcs/all
     */
    public static final String DISCOVERY_HOT = "http://baobab.kaiyanapp.com/api/v4/discovery/hot";
     ...
     * - `system_version_code`：手机系统版本。该参数可为空也可去除
     * <p>
     * url 示例：http://baobab.kaiyanapp.com/api/v4/tabs/follow?start=0&num=10&follow=false&startId=0
     */
